...
program
    ...
    .option("-l, --listen-address [address...]", "list of listen addresses (default: 0.0.0.0)")
    .option("-s, --sender", "sender (default: true)")
    .option("-r, --reciever", "reciever")
    .option("-t, --transport <type>", "transport type (default: tcp)")
    .description("Transnip utility manages and synchronizes clipboard text across multiple devices in the local network.")
    .version("v0.0.1")
    .parse();
const options = program.opts();
if ((options === null || options === void 0 ? void 0 : options.sender) && (options === null || options === void 0 ? void 0 : options.reciever)) {
